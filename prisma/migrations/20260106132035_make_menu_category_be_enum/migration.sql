/*
  ...
  - A unique constraint covering the columns `[imagePath]` on the table `Menu` will be added. If there are existing duplicate values, this will fail.
...
*/
-- CreateEnum
CREATE TYPE "public"."Category" AS ENUM ('hot', 'cold', 'bakery');
...
-- AlterTable
ALTER TABLE "public"."Menu" DROP COLUMN "type",
...
-- CreateIndex
CREATE UNIQUE INDEX "Menu_imagePath_key" ON "public"."Menu"("imagePath");
